<div class="grid grid-cols-1 md:grid-cols-2 bg-gray-50 w-3/4 m-auto rounded p-3 shadow mt-5">
    <div>
    ...
    <div>
        ...
        <form wire:submit.prevent="submitForm" method="post">
            ...
            <button class="bg-black text-white rounded p-2 disabled:opacity-50 inline-flex" type="submit">
                <svg wire:loading.delay class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
